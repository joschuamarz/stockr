//
//  LoadedStock+CoreDataProperties.swift
//  stockr
//
...
extension LoadedStock {

    @nonobjc public class func fetchRequest() -> NSFetchRequest<LoadedStock> {
...
extension LoadedStock : Identifiable {
